...
var ChatComponent = /** @class */ (function () {
    ...
    ChatComponent.prototype.test2 = function (id, isgroup) {
        this.isslect = true;
        this.to_id = id;
    ...
    ChatComponent.prototype.uploadFile = function (files) {
        ...
        this.upload.uploadFile(this.fileurl, file).subscribe(function (response) {
            ...
            if (response["body"] != null) {
                ...
                msg.contentType = _protocol_Protocol__WEBPACK_IMPORTED_MODULE_5__["Protocol"].Message.ContentType.FILE;
                msg.isgroup = false;

...
module.exports = "/* :host ::ng-deep .demo-infinite-container {\n    height: 300px;\n    border: 1px solid #e8e8e8;\n    border-radius: 4px;\n  } */\n\n:host ::ng-deep .demo-infinite-container {\n  height: 300px;\n  border: 1px solid #e8e8e8;\n  border-radius: 4px;\n}\n\n.avatar{\n  height: 80px;\n  width: 200px;\n\n}\n\n.avatar2{\n  overflow-y: auto;\n  overflow-x:none;\n  height: 80px;\n  width: 200px;\n}\n\n.container{\n  /* background-color:rgb(223, 219, 219); */\n  background-color: #DDDDDD;\n  width: 1002px;\n  height: 740px;\n  position: absolute;\n  margin: auto;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  z-index: 1;\n  border-color: #616060;\n  /* border: 2px;\n  color: #000000 */\n}\n\n.search{\n  position:absolute;\n  margin-top: 15px;\n  margin-left: 5px;\n  width: 240px;\n  height: 30px;\n}\n\n.icon{\n  cursor: pointer;\n}\n\n.list{\n  background-color: #7a7a7a;\n  width: 250px;\n  height: 590px;\n  /* color: white; */\n\n  /* overflow-y:scroll;  纵向滚动条始终显示 */\n  overflow-y: auto;\n  overflow-x:none;\n}\n\n.item{\n  color: white;\n  border-bottom:1px solid #EEE;\n  height: 65px;\n  font-size: 12px;\n  /* font-display: center; */\n  vertical-align: middle;\n  /* text-align: center; */\n  position: relative;\n  cursor: pointer;\n\n}\n\n.item:hover{\n  background-color: #8a8a8a;\n}\n\n/* nz-list-item{\n  color: white;\n} */\n\n.img{\n  /* margin: 5px; */\n  /* margin-top: 10px; */\n  height:40px; \n  width:40px; \n  position: relative;\n  /* border-radius:50%;  */\n  overflow:hidden;\n}\n\n.message{\n  width: 750px;\n  height: 480px;\n  background-color: #F9F9F9;\n  padding: 0px;\n  overflow-y: auto;\n  overflow-x: none;\n  vertical-align: top;\n}\n\n.message1{\n  width: 750px;\n  height: 480px;\n  background-color: #F9F9F9;\n  padding: 10px;\n  overflow-y: auto;\n  overflow-x: none;\n  vertical-align: top;\n}\n\n.inputmes{\n  width: 749px;\n  height: 200px;\n  background-color: white;\n}\n\n.him{\n  height: 60px;\n  color: #444444;\n}\n\n.textarea{\n  background-color: white;\n  resize: none;\n  width: 750px;\n  height: 140px;\n  position: absolute;\n  padding: 10px;\n  border: none;\n  outline: none;\n  /* margin-top: 30px; */\n}\n\n.tool{\n  width: 750px;\n  background-color: #EEEEEE;\n  height: 30px;\n  cursor: pointer;\n\n}\n\n.icon{\n  margin-left: 15px;\n  margin-top: 3px;\n  color: #777777;\n}\n\n.send{\n  position: absolute;\n  margin-left: 680px;\n  margin-top: 130px;\n}\n\n/* .arrow {\n  vertical-align: middle;\n  width:200px;\n  height:25px;\n  font-size:16px;\n  background-color: #AABBCC ;\n  margin: 15px;\n  overflow-wrap: normal;\n} */\n\n#box{\n  min-height: 30px;          \n  border-radius: 5px;        \n  /* line-height: 50px;         */\n  margin-left: 10px;        \n  word-break: break-word;        \n  color: white;        \n  padding: 5px;        \n  line-height: 18px;\n\n\n    position: relative;\n    left:30px; \n    width: 140px;\n    min-height: 30px;\n    line-height: 20px;\n    margin-left: 10px;\n    word-wrap: 5px;\n    background: #088cb7;\n    border-radius: 4px;\n    padding: 10px;\n    margin-top:10px;\n    vertical-align: middle;\n    text-align: center;\n}\n\n/*左方说话*/\n\n#box:before{\n    position: absolute;\n    content: \"\";\n    width: 0;\n    height: 0;\n    right: 100%;\n    top: 9px;\n    border-top: 5px solid transparent;\n    border-right: 13px solid #088cb7;\n    border-bottom: 6px solid transparent;\n}\n\n/*右方说话*/\n\n#box1{          \n  min-height: 30px;          \n  border-radius: 5px;        \n  /* line-height: 50px;         */\n  margin-right: 10px;        \n  word-break: break-word;        \n  color: white;        \n  padding: 5px;        \n  line-height: 18px;\n\n  position: relative;\n  left:560px; \n  width: 140px;\n  /* height: 30px; */\n  background: #088cb7;\n  border-radius: 4px;\n  /* padding: 10px; */\n  margin-top:10px;\n  vertical-align: middle;\n  text-align: center;\n}\n\n#box1:before{\n  position: absolute;\n    content: \"\";\n    width: 0;\n    height: 0;\n    left: 100%;\n    top: 9px;\n    border-top: 5px solid transparent;\n    border-left: 13px solid #088cb7;\n    border-bottom: 6px solid transparent;\n}\n\n.tips{\n  position: relative; \n  text-align: center;\n  vertical-align: middle;;\n}\n\n.grad{\n  width: 80px;\n  background-color:transparent;\n  border: 0px;\n  outline: none;\n  cursor: pointer;\n  height: 25px;\n}\n\n.point{\n  /* width: 2px; */\n  /* left: 60px; */\n  margin:5px;\n}\n\n.smallContainer{\n  width: 240px;\n  background-color: #FFFFFF;\n  position:absolute;\n  text-align: center;\n  z-index: 50;\n}\n\n.headportrait{\n  position: relative;\n  width:230px;\n  height:230px;\n  bottom: -26px;\n  margin-left:26px;\n  cursor:pointer;\n}\n\n:host ::ng-deep .headportrait img{\n  width:100%;height:100%;\n\n}\n\n.mask  {    \n  position: absolute;    \n  width: 100%;    \n  height: 100%;      \n  background: #868c89;    \n  opacity: 0;\t\n  color: black;\n  text-align: center;\n  line-height:230px;\n  margin-top: -230px;\n}\n\n/*hover状态（按你的需求）控制显示。opacity/display/z-index都可以*/\n\n.headportrait:hover .mask {    opacity: .5;\t}\n\n.upload-btn {\nbackground-color: #337ab7;\ncolor: #fff;\nborder-radius: 2px;\nborder: none;\n/* padding: .5rem 1.3rem; */\ncursor: pointer;\nheight: 30px;\n}\n\n.picture {\nwidth: 7rem;\n/* height: 7rem; */\nmargin-right: 1rem;\nbackground-size: cover;\n}\n\n.action-box {\nmargin-left: 1rem;\n}\n\n.hint {\ncolor: #909090;\nfont-size: 1.7rem;\nmargin-bottom: 1.5rem;\n}\n\n.dropdown{\n  z-index: 100;\n  position:absolute;\n  margin-left: 16px;\n  background-position-y: 230px;  \n  width: 80px;\n  height: 25px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ChatComponent = /** @class */ (function () {
    ...
    ChatComponent.prototype.he = function (event) {
        if (event.button == 2)
            console.log("点击右键");
    ...
    ChatComponent.prototype.test2 = function (id, name, img, isgroup) {
        ...
        var flag = false;
        for (var i_1 = 0; i_1 < this.friendlist.List.length; i_1++) {
            if (id == this.friendlist.List[i_1].ID) {
                this.friendlist.List[i_1].Counter = 0;
            }
        }
...
var WebsocketService = /** @class */ (function () {
    ...
    WebsocketService.prototype.delectMessage = function (id) {
    };
    // 按名字取得用户列表
